...
export const Header: React.FC<HeaderProps> = () => {
  return (
    <header className="relative w-full body-font pt-10">
      <div className="container flex flex-col flex-wrap items-center justify-between px-8 py-5 mx-auto md:flex-row max-w-7xl">
        <Logo />
        <nav className="left-0 z-0 flex items-center justify-center w-full h-full py-5 -ml-0 text-base top-5 space-x-2 sm:space-x-5 md:py-0 md:absolute">
